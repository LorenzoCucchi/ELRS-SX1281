...
(library Library_1
	...
	(patternDef "ANTC1608X40N" (originalName "ANTC1608X40N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 0.025) (pt -0.425 0.4) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "2450AT14A0100T" (originalName "2450AT14A0100T") (compHeader (numPins 2) (numParts 1) (refDesPrefix ANT)
		...
		(attr "<Hyperlink>" "https://www.johansontechnology.com/datasheets/2450AT14A0100/2450AT14A0100.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "2450AT14A0100T.stp")
